                ...
                <td>
                  <form action="{{ route('room_delete', $data->id) }}" method="post">
                    <div class="flex align-items-center list-user-action">
                      <a class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add" href="{{ route('room_details', $data->id) }}">
                      ...
                      <a class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ route('room_edit', $data->id) }}">
                        <span class="btn-inner">
