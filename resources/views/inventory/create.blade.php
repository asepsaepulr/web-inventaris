            ...
            <div class="card-body">
                ...
                <div class="bd-example">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Create Page Inventory</li>
...
</div> @elseif ($errors->any()) <div class="alert alert-danger">
    <ul> @foreach ($errors->all() as $error) <li>{{ $error }}</li> @endforeach </ul>
</div> @endif <div class="col-xl-8 col-lg-8">
    <div class="card">
                ...
                <form method="post" action="{{ route('inventory_create_form') }}">
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input name="inventory_code" type="text" class="form-control" placeholder="Inventory Code" aria-label="inventory_code" aria-describedby="basic-addon1">
                        </div>
                    </div>
