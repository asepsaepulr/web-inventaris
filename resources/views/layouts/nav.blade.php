                ...
                <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <li>
                                ...
                                <a class="dropdown-item" href="{{ route('logout') }}l" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
        ...
        <div class="row">
            ...
            <div class="flex-wrap d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <p>Don't forget to manage your room!</p>
